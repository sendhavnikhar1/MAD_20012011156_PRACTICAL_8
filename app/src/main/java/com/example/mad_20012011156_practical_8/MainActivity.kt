package com.example.mad_20012011156_practical_8
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        alaram_img.setBackgroundResource(R.drawable.alarml_list)
        alarm_animation = alaram_img.background as AnimationDrawable
        heart_img = findViewById(R.id.heart_list)
        heart_img.setBackgroundResource(R.drawable.heartlist)
